...
class JBDBMS:
    ...
    class COMMAND(Enum):
        ...
        READ_CHARGING_HIGH_TEMP_PROTECTION = 0x18
        READ_CHARGING_HIGH_TEMP_RECOVERY = 0x19
        READ_CHARGING_LOW_TEMP_PROTECTION = 0x1A
        READ_CHARGING_LOW_TEMP_RECOVERY = 0x1B
        READ_CHARGING_DELAY = 0x3A

        READ_DISCHARGING_HIGH_TEMP_PROTECTION = 0x1c
        READ_DISCHARGING_HIGH_TEMP_RECOVERY = 0x1d
        READ_DISCHARGING_LOW_TEMP_PROTECTION = 0x1e
        READ_DISCHARGING_LOW_TEMP_RECOVERY = 0x1f
        READ_DISCHARGING_DELAY = 0x3B

        READ_CAPACITY_V_100 = 0x47
        READ_CAPACITY_V_90 = 0x42
        READ_CAPACITY_V_80 = 0x32
        READ_CAPACITY_V_70 = 0x43
        READ_CAPACITY_V_60 = 0x33
        READ_CAPACITY_V_50 = 0x44
        READ_CAPACITY_V_40 = 0x34
        READ_CAPACITY_V_30 = 0x45
        READ_CAPACITY_V_20 = 0x35
        READ_CAPACITY_V_10 = 0x46

    
        READ_BARCODE = 0xa2
        READ_MODEL = 0xa1
        
        READ_CELL_HIGH_PROTECT = 0x24
        READ_CELL_HIGH_RECOVER = 0x25
